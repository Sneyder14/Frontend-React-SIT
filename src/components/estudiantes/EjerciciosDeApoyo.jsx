...
export default function EjerciciosDeApoyo() {
    ...
    if (loading) return <div className="p-6 text-gray-500">Cargando ejercicios...</div>;
    if (error) return <div className="p-6 text-red-500">{error}</div>;

    return (
        <div className="h-full overflow-y-auto px-6 py-4b">
            <div className="px-6 py-4 animate-fade ">
                <h2 className="text-xl  mb-6 flex items-center justify-center gap-2 uppercase font-bold font-[poppins] text-[#101828] text-center">
                    ...
                    {ejercicios.map((ej) => (
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-2 text-xs text-gray-500">
                                ...
                                <span className={`px-2 py-1 rounded-full font-medium ${ej.status === "completado"
